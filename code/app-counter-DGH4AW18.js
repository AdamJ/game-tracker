...
`+l}render(){const e=new Map;this.playerLogs.forEach(t=>{e.has(t.player)||e.set(t.player,[]);const a=this.getPlayerIconVariant(t),o=this.getPlayerBadgeVariant(t),w=p`
        ...
        `;e.get(t.player)?.push(w)});const s=[];for(const[t,a]of e)s.push(p`
    ...
    `];i([d({type:Object})],r.prototype,"handle1",2);i([d({type:Object})],r.prototype,"handle2",2);i([d({type:Object})],r.prototype,"handle3",2);i([d({type:Object})],r.prototype,"handle4",2);i([c()],r.prototype,"matchResults",2);i([c()],r.prototype,"playerHandle1",2);i([c()],r.prototype,"playerHandle2",2);i([c()],r.prototype,"playerHandle3",2);i([c()],r.prototype,"playerHandle4",2);i([c()],r.prototype,"initialLifeTracker",2);i([d({type:Array})],r.prototype,"gameHistory",2);i([c()],r.prototype,"playerLogs",2);i([c()],r.prototype,"playerHandle1Actions",2);i([c()],r.prototype,"playerHandle2Actions",2);i([c()],r.prototype,"playerHandle3Actions",2);i([c()],r.prototype,"playerHandle4Actions",2);r=i([b("match-tracker")],r);var A=Object.defineProperty,j=Object.getOwnPropertyDescriptor,y=(e,s,l,n)=>{for(var t=n>1?void 0:n?j(s,l):s,a=e.length-1,o;a>=0;a--)(o=e[a])&&(t=(n?o(s,l,t):o(t))||t);return n&&t&&A(s,l,t),t};let h=class extends u{constructor(){super(...arguments),this.icon="arrow-left",this.isOpen=!1,this.message="",this.pointsTracker=""}openFab(e){this.pointsTracker=e,this.isOpen=!0}open(e){this.message=e,this.isOpen=!0}close(){this.dispatchEvent(new CustomEvent("close")),this.isOpen=!1}render(){return this.isOpen?p`
      <sl-drawer
        placement="top"
        label="Drawer"
        with-header
    ...
    `:p``}};y([d({type:String})],h.prototype,"icon",2);y([d({type:Boolean})],h.prototype,"isOpen",2);y([d({type:String})],h.prototype,"message",2);y([d({type:String})],h.prototype,"pointsTracker",2);h=y([b("fab-drawer")],h);var z=Object.defineProperty,R=Object.getOwnPropertyDescriptor,x=(e,s,l,n)=>{for(var t=n>1?void 0:n?R(s,l):s,a=e.length-1,o;a>=0;a--)(o=e[a])&&(t=(n?o(s,l,t):o(t))||t);return n&&t&&z(s,l,t),t};let m=class extends u{constructor(){super(...arguments),this.fabDrawerOpen=!1}openFabDrawer(){this.fabDrawerOpen=!0}closeFabDrawer(){this.fabDrawerOpen=!1}fabTab(){return p`
