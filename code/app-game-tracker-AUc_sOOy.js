...
`);this.downloadCSV(e,"standings.csv")}downloadCSV(e,t){const s=new Blob([e],{type:"text/csv;charset=utf-8;"}),r=URL.createObjectURL(s),a=document.createElement("a");a.href=r,a.setAttribute("download",t),document.body.appendChild(a),a.click(),document.body.removeChild(a)}async clearMatchResultsConfirmed(){this.matchHistory=[],await c.saveMatchHistory(this.matchHistory),this.calculateStandings(),this.requestUpdate()}openConfirmationModal(){this.confirmationModalOpen=!0}closeConfirmationModal(){this.confirmationModalOpen=!1}async clearStandingsConfirmed(){this.standings=[],this.matchHistory=[],await c.removeItem(d.MATCH_HISTORY),this.calculateStandings(),this.requestUpdate(),this.closeConfirmationModal()}setActiveTab(e){this.activeTab=e}render(){return this.isLoading?n`
    ...
    `}};p.styles=[S,w,D];h([o()],p.prototype,"activeTab",2);h([o()],p.prototype,"players",2);h([o()],p.prototype,"matchHistory",2);h([o()],p.prototype,"standings",2);h([o()],p.prototype,"isLoading",2);h([o()],p.prototype,"editModalOpen",2);h([o()],p.prototype,"editMatchIndex",2);h([o()],p.prototype,"confirmationModalOpen",2);p=h([m("standings-tracker")],p);var k=Object.getOwnPropertyDescriptor,ee=(e,t,s,r)=>{for(var a=r>1?void 0:r?k(t,s):t,l=e.length-1,i;l>=0;l--)(i=e[l])&&(a=i(a)||a);return a};let C=class extends u{render(){return n`
...
//# sourceMappingURL=app-game-tracker-AUc_sOOy.js.map
