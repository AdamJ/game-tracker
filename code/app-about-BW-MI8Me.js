import{i as h,r as u,a as c,x as i,s as d,t as l}from"./index-BIPfO2ow.js";const m=h`
  @media(min-width: 1000px) {
    sl-card {
      max-width: 70vw;
    }
  }
`;var b=Object.getOwnPropertyDescriptor,v=(t,r,p,o)=>{for(var e=o>1?void 0:o?b(r,p):r,a=t.length-1,n;a>=0;a--)(n=t[a])&&(e=n(e)||e);return e};let s=class extends u{render(){return i`
      ...
      <main>
        ...
        <sl-card>
          ...
          <sl-button href="${c("counter")}" variant="primary">Counter</sl-button>
...
//# sourceMappingURL=app-about-BW-MI8Me.js.map
