import{s as x,a as f,i as P,n as d,r as o,b as h,x as n,t as y}from"./index-iV2mvn9b.js";import{t as R}from"./table-styles-BZ0nevQi.js";var C=Object.freeze,H=Object.defineProperty,z=Object.getOwnPropertyDescriptor,O=(e,t,s,l)=>{for(var a=l>1?void 0:l?z(t,s):t,r=e.length-1,i;r>=0;r--)(i=e[r])&&(a=(l?i(t,s,a):i(a))||a);return l&&a&&H(t,s,a),a},A=(e,t)=>C(H(e,"raw",{value:C(e.slice())})),E;let m=class extends h{constructor(){super(...arguments),this.players=[],this.newPlayer="",this.errorMessage=""}handleSubmit(e){e.preventDefault(),this.addPlayer()}addPlayer(){if(console.log("addPlayer called"),this.newPlayer&&this.validatePlayerName(this.newPlayer)){this.dispatchEvent(new CustomEvent("player-added",{detail:this.newPlayer})),this.newPlayer="";const e=this.shadowRoot.querySelector("sl-input");e&&(e.helpText="")}else{const e=this.shadowRoot.querySelector("sl-input");e&&(e.helpText=this.errorMessage)}}handleInputChange(e){const t=e.target;this.newPlayer=t.value;const s=this.shadowRoot.querySelector("sl-input");s&&(this.validatePlayerName(this.newPlayer)?s.helpText="":s.helpText=this.errorMessage)}validatePlayerName(e){const t=/^[a-zA-Z0-9]+$/.test(e);return console.log("isValid:",t),t?(this.errorMessage="",!0):(this.errorMessage="Enter a Name containing only letters or numbers with no spaces or special characters.",!1)}removePlayer(e){this.dispatchEvent(new CustomEvent("remove-player",{detail:e}))}clearAllPlayers(){this.dispatchEvent(new CustomEvent("clear-all-players"))}render(){return n(E||(E=A([`
    ...
    `];O([d({type:Array})],m.prototype,"players",2);O([o()],m.prototype,"newPlayer",2);O([o()],m.prototype,"errorMessage",2);m=O([y("player-input")],m);const D=P`
  sl-input::part(base) {
...
`;var N=Object.defineProperty,W=Object.getOwnPropertyDescriptor,v=(e,t,s,l)=>{for(var a=l>1?void 0:l?W(t,s):t,r=e.length-1,i;r>=0;r--)(i=e[r])&&(a=(l?i(t,s,a):i(a))||a);return l&&a&&N(t,s,a),a};let u=class extends h{constructor(){super(...arguments),this.players=[],this.player1="",this.player2="",this.winner="draw"}recordMatch(){if(this.player1&&this.player2&&this.player1!==this.player2){let e;this.winner==="draw"?e="draw":this.winner===this.player1?e="win":e="loss",this.dispatchEvent(new CustomEvent("match-recorded",{detail:{player1:this.player1,player2:this.player2,result:e,winner:this.winner}}))}}handlePlayer1Change(e){const t=e.target;this.player1=t.value,(this.winner===this.player2||this.winner===this.player1)&&(this.winner="draw")}handlePlayer2Change(e){const t=e.target;this.player2=t.value,(this.winner===this.player1||this.winner===this.player2)&&(this.winner="draw")}handleWinnerChange(e){const t=e.target;this.winner=t.value==="draw"?"draw":t.value}render(){const e=this.players.filter(r=>r.name!==this.player2),t=this.players.filter(r=>r.name!==this.player1),s=this.player1!==""&&this.player2!=="",l=this.player1===""?"Player 1":this.player1,a=this.player2===""?"Player 2":this.player2;return n`
    ...
    `}};u.styles=[f,D];v([d({type:Array})],u.prototype,"players",2);v([o()],u.prototype,"player1",2);v([o()],u.prototype,"player2",2);v([o()],u.prototype,"winner",2);u=v([y("match-input")],u);var T=Object.defineProperty,q=Object.getOwnPropertyDescriptor,j=(e,t,s,l)=>{for(var a=l>1?void 0:l?q(t,s):t,r=e.length-1,i;r>=0;r--)(i=e[r])&&(a=(l?i(t,s,a):i(a))||a);return l&&a&&T(t,s,a),a};let b=class extends h{constructor(){super(...arguments),this.standings=[]}render(){return n`
    ...
    `}};b.styles=[x,f,R,P`
  `];j([d({type:Array})],b.prototype,"standings",2);b=j([y("standings-display")],b);var V=Object.defineProperty,J=Object.getOwnPropertyDescriptor,S=(e,t,s,l)=>{for(var a=l>1?void 0:l?J(t,s):t,r=e.length-1,i;r>=0;r--)(i=e[r])&&(a=(l?i(t,s,a):i(a))||a);return l&&a&&V(t,s,a),a};let g=class extends h{constructor(){super(...arguments),this.match=null,this.isOpen=!1,this.editedWinner="draw"}open(e){this.match=e,this.editedWinner=e.winner,this.isOpen=!0}close(){this.dispatchEvent(new CustomEvent("close")),this.isOpen=!1}confirm(){if(this.match){let e;this.editedWinner==="draw"?e="draw":this.editedWinner===this.match.player1?e="win":e="loss",this.dispatchEvent(new CustomEvent("match-edited",{detail:{...this.match,result:e,winner:this.editedWinner}})),this.close()}}handleWinnerChange(e){const t=e.target;this.editedWinner=t.value==="draw"?"draw":t.value}render(){return!this.isOpen||!this.match?n``:n`
      <sl-dialog
        label="Edit Results"
        ?open=${this.isOpen}
    ...
    `}};S([d({type:Object})],g.prototype,"match",2);S([d({type:Boolean})],g.prototype,"isOpen",2);S([o()],g.prototype,"editedWinner",2);g=S([y("edit-modal")],g);var L=Object.defineProperty,U=Object.getOwnPropertyDescriptor,I=(e,t,s,l)=>{for(var a=l>1?void 0:l?U(t,s):t,r=e.length-1,i;r>=0;r--)(i=e[r])&&(a=(l?i(t,s,a):i(a))||a);return l&&a&&L(t,s,a),a};let w=class extends h{constructor(){super(...arguments),this.matchHistory=[]}editMatch(e){this.dispatchEvent(new CustomEvent("edit-match",{detail:e}))}getPlayerBadgeVariant(e,t){return t.winner==="draw"?"neutral":t.winner===e?"success":"danger"}getPlayerIconVariant(e,t){return t.winner==="draw"?"bookmarks":t.winner===e?"trophy":"emoji-frown"}getPlayerResultString(e,t){return t.winner==="draw"?"draw":t.winner===e?"win":"loss"}render(){return n`
      <sl-menu>
    ...
    `}};w.styles=[f];I([d({type:Array})],w.prototype,"matchHistory",2);w=I([y("match-history")],w);var B=Object.defineProperty,F=Object.getOwnPropertyDescriptor,_=(e,t,s,l)=>{for(var a=l>1?void 0:l?F(t,s):t,r=e.length-1,i;r>=0;r--)(i=e[r])&&(a=(l?i(t,s,a):i(a))||a);return l&&a&&B(t,s,a),a};let $=class extends h{constructor(){super(...arguments),this.isOpen=!1,this.message=""}open(e){this.message=e,this.isOpen=!0}close(){this.dispatchEvent(new CustomEvent("close")),this.isOpen=!1}confirm(){this.dispatchEvent(new CustomEvent("confirm")),this.close()}render(){return this.isOpen?n`
      <sl-dialog
...
`);this.downloadCSV(e,"standings.csv")}downloadCSV(e,t){const s=new Blob([e],{type:"text/csv;charset=utf-8;"}),l=URL.createObjectURL(s),a=document.createElement("a");a.href=l,a.setAttribute("download",t),document.body.appendChild(a),a.click(),document.body.removeChild(a)}clearMatchResultsConfirmed(){this.matchHistory=[],localStorage.setItem("matchHistory",JSON.stringify(this.matchHistory)),this.calculateStandings(),this.requestUpdate()}openConfirmationModal(){this.confirmationModalOpen=!0}closeConfirmationModal(){this.confirmationModalOpen=!1}clearStandingsConfirmed(){this.standings=[],localStorage.removeItem("matchHistory"),this.requestUpdate(),this.closeConfirmationModal()}setActiveTab(e){this.activeTab=e}render(){return this.isLoading?n`
    ...
    `}};p.styles=[x,f,D];c([o()],p.prototype,"activeTab",2);c([o()],p.prototype,"players",2);c([o()],p.prototype,"matchHistory",2);c([o()],p.prototype,"standings",2);c([o()],p.prototype,"isLoading",2);c([o()],p.prototype,"editModalOpen",2);c([o()],p.prototype,"editMatchIndex",2);c([o()],p.prototype,"confirmationModalOpen",2);p=c([y("standings-tracker")],p);var K=Object.getOwnPropertyDescriptor,Q=(e,t,s,l)=>{for(var a=l>1?void 0:l?K(t,s):t,r=e.length-1,i;r>=0;r--)(i=e[r])&&(a=i(a)||a);return a};let M=class extends h{render(){return n`
    ...
    `}};M.styles=[x,P`
    `];M=Q([y("app-standings")],M);export{M as AppDashboard};
//# sourceMappingURL=app-game-tracker-CbG5Ecc6.js.map
