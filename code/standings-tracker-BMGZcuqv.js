import{s as O,c as w,a as _,n as y,r as o,i as m,b as n,t as g}from"./shoelace-styles-DuBzW-jG.js";import{l as R,t as j}from"./table-styles-DrheAqdc.js";import"./alert-styles-cAzKvmdU.js";const h={PLAYERS:"players",MATCH_HISTORY:"matchHistory",PLAYER_DATA:"playerData",APP_SETTINGS:"appSettings"};class L{constructor(){this.store=R.createInstance({name:"game-tracker-db",storeName:"game_data",description:"Game tracker application data"})}async getItem(t){try{return await this.store.getItem(t)}catch(s){return console.error(`Error getting item ${t}:`,s),null}}async setItem(t,s){try{return await this.store.setItem(t,s),!0}catch(r){return console.error(`Error setting item ${t}:`,r),!1}}async removeItem(t){try{return await this.store.removeItem(t),!0}catch(s){return console.error(`Error removing item ${t}:`,s),!1}}async clear(){try{return await this.store.clear(),!0}catch(t){return console.error("Error clearing storage:",t),!1}}async keys(){try{return await this.store.keys()}catch(t){return console.error("Error getting keys:",t),[]}}async length(){try{return await this.store.length()}catch(t){return console.error("Error getting length:",t),0}}async getPlayers(){return await this.getItem(h.PLAYERS)||[]}async savePlayers(t){return await this.setItem(h.PLAYERS,t)}async getMatchHistory(){return await this.getItem(h.MATCH_HISTORY)||[]}async saveMatchHistory(t){return await this.setItem(h.MATCH_HISTORY,t)}async getPlayerData(){return await this.getItem(h.PLAYER_DATA)}async savePlayerData(t){return await this.setItem(h.PLAYER_DATA,t)}async getAppSettings(){return await this.getItem(h.APP_SETTINGS)||{theme:"auto",defaultLifeTotal:40,enableNotifications:!0}}async saveAppSettings(t){return await this.setItem(h.APP_SETTINGS,t)}async migrateFromLocalStorage(){try{const t=localStorage.getItem("players");if(t){const r=JSON.parse(t);await this.savePlayers(r),console.log("Migrated players from localStorage")}const s=localStorage.getItem("matchHistory");if(s){const r=JSON.parse(s);await this.saveMatchHistory(r),console.log("Migrated match history from localStorage")}}catch(t){console.error("Error migrating from localStorage:",t)}}async exportAllData(){const t={},s=await this.keys();for(const r of s)t[r]=await this.store.getItem(r);return t}async importData(t){try{for(const[s,r]of Object.entries(t))await this.store.setItem(s,r);return!0}catch(s){return console.error("Error importing data:",s),!1}}}const c=new L;var C=Object.freeze,I=Object.defineProperty,z=Object.getOwnPropertyDescriptor,S=(e,t,s,r)=>{for(var a=r>1?void 0:r?z(t,s):t,l=e.length-1,i;l>=0;l--)(i=e[l])&&(a=(r?i(t,s,a):i(a))||a);return r&&a&&I(t,s,a),a},W=(e,t)=>C(I(e,"raw",{value:C(e.slice())})),H;let f=class extends m{constructor(){super(...arguments),this.players=[],this.newPlayer="",this.errorMessage=""}handleSubmit(e){e.preventDefault(),this.addPlayer()}addPlayer(){if(this.newPlayer&&this.validatePlayerName(this.newPlayer)){this.dispatchEvent(new CustomEvent("player-added",{detail:this.newPlayer})),this.newPlayer="";const e=this.shadowRoot.querySelector("sl-input");e&&(e.helpText="")}else{const e=this.shadowRoot.querySelector("sl-input");e&&(e.helpText=this.errorMessage)}}handleInputChange(e){const t=e.target;this.newPlayer=t.value;const s=this.shadowRoot.querySelector("sl-input");s&&(this.validatePlayerName(this.newPlayer)?s.helpText="":s.helpText=this.errorMessage)}validatePlayerName(e){return/^[a-zA-Z0-9]+$/.test(e)?(this.errorMessage="",!0):(this.errorMessage="Enter a Name containing only letters or numbers with no spaces or special characters.",!1)}removePlayer(e){this.dispatchEvent(new CustomEvent("remove-player",{detail:e}))}clearAllPlayers(){this.dispatchEvent(new CustomEvent("clear-all-players"))}render(){return n(H||(H=W([`
    ...
    `];S([y({type:Array})],f.prototype,"players",2);S([o()],f.prototype,"newPlayer",2);S([o()],f.prototype,"errorMessage",2);f=S([g("player-input")],f);const A=_`
  sl-input::part(base) {
...
`;var q=Object.defineProperty,N=Object.getOwnPropertyDescriptor,b=(e,t,s,r)=>{for(var a=r>1?void 0:r?N(t,s):t,l=e.length-1,i;l>=0;l--)(i=e[l])&&(a=(r?i(t,s,a):i(a))||a);return r&&a&&q(t,s,a),a};let u=class extends m{constructor(){super(...arguments),this.players=[],this.player1="",this.player2="",this.winner="draw"}recordMatch(){if(this.player1&&this.player2&&this.player1!==this.player2){let e;this.winner==="draw"?e="draw":this.winner===this.player1?e="win":e="loss",this.dispatchEvent(new CustomEvent("match-recorded",{detail:{player1:this.player1,player2:this.player2,result:e,winner:this.winner}}))}}handlePlayer1Change(e){const t=e.target;this.player1=t.value,(this.winner===this.player2||this.winner===this.player1)&&(this.winner="draw")}handlePlayer2Change(e){const t=e.target;this.player2=t.value,(this.winner===this.player1||this.winner===this.player2)&&(this.winner="draw")}handleWinnerChange(e){const t=e.target;this.winner=t.value==="draw"?"draw":t.value}render(){const e=this.players.filter(l=>l.name!==this.player2),t=this.players.filter(l=>l.name!==this.player1),s=this.player1!==""&&this.player2!=="",r=this.player1===""?"Player 1":this.player1,a=this.player2===""?"Player 2":this.player2;return n`
    ...
    `}};u.styles=[w,A];b([y({type:Array})],u.prototype,"players",2);b([o()],u.prototype,"player1",2);b([o()],u.prototype,"player2",2);b([o()],u.prototype,"winner",2);u=b([g("match-input")],u);var V=Object.defineProperty,U=Object.getOwnPropertyDescriptor,D=(e,t,s,r)=>{for(var a=r>1?void 0:r?U(t,s):t,l=e.length-1,i;l>=0;l--)(i=e[l])&&(a=(r?i(t,s,a):i(a))||a);return r&&a&&V(t,s,a),a};let $=class extends m{constructor(){super(...arguments),this.standings=[]}render(){return n`
    ...
    `}};$.styles=[O,w,j,_`
  `];D([y({type:Array})],$.prototype,"standings",2);$=D([g("standings-display")],$);var Y=Object.defineProperty,B=Object.getOwnPropertyDescriptor,M=(e,t,s,r)=>{for(var a=r>1?void 0:r?B(t,s):t,l=e.length-1,i;l>=0;l--)(i=e[l])&&(a=(r?i(t,s,a):i(a))||a);return r&&a&&Y(t,s,a),a};let v=class extends m{constructor(){super(...arguments),this.match=null,this.isOpen=!1,this.editedWinner="draw"}open(e){this.match=e,this.editedWinner=e.winner,this.isOpen=!0}close(){this.dispatchEvent(new CustomEvent("close")),this.isOpen=!1}confirm(){if(this.match){let e;this.editedWinner==="draw"?e="draw":this.editedWinner===this.match.player1?e="win":e="loss",this.dispatchEvent(new CustomEvent("match-edited",{detail:{...this.match,result:e,winner:this.editedWinner}})),this.close()}}handleWinnerChange(e){const t=e.target;this.editedWinner=t.value==="draw"?"draw":t.value}render(){return!this.isOpen||!this.match?n``:n`
      <sl-dialog
        label="Edit Results"
        ?open=${this.isOpen}
    ...
    `}};M([y({type:Object})],v.prototype,"match",2);M([y({type:Boolean})],v.prototype,"isOpen",2);M([o()],v.prototype,"editedWinner",2);v=M([g("edit-modal")],v);var G=Object.defineProperty,F=Object.getOwnPropertyDescriptor,T=(e,t,s,r)=>{for(var a=r>1?void 0:r?F(t,s):t,l=e.length-1,i;l>=0;l--)(i=e[l])&&(a=(r?i(t,s,a):i(a))||a);return r&&a&&G(t,s,a),a};let P=class extends m{constructor(){super(...arguments),this.matchHistory=[]}editMatch(e){this.dispatchEvent(new CustomEvent("edit-match",{detail:e}))}getPlayerBadgeVariant(e,t){return t.winner==="draw"?"neutral":t.winner===e?"success":"danger"}getPlayerIconVariant(e,t){return t.winner==="draw"?"bookmarks":t.winner===e?"trophy":"emoji-frown"}getPlayerResultString(e,t){return t.winner==="draw"?"draw":t.winner===e?"win":"loss"}render(){return n`
      <sl-menu>
    ...
    `}};P.styles=[w];T([y({type:Array})],P.prototype,"matchHistory",2);P=T([g("match-history")],P);var J=Object.defineProperty,K=Object.getOwnPropertyDescriptor,E=(e,t,s,r)=>{for(var a=r>1?void 0:r?K(t,s):t,l=e.length-1,i;l>=0;l--)(i=e[l])&&(a=(r?i(t,s,a):i(a))||a);return r&&a&&J(t,s,a),a};let x=class extends m{constructor(){super(...arguments),this.isOpen=!1,this.message=""}open(e){this.message=e,this.isOpen=!0}close(){this.dispatchEvent(new CustomEvent("close")),this.isOpen=!1}confirm(){this.dispatchEvent(new CustomEvent("confirm")),this.close()}render(){return this.isOpen?n`
      <sl-dialog
...
`);this.downloadCSV(e,"standings.csv")}downloadCSV(e,t){const s=new Blob([e],{type:"text/csv;charset=utf-8;"}),r=URL.createObjectURL(s),a=document.createElement("a");a.href=r,a.setAttribute("download",t),document.body.appendChild(a),a.click(),document.body.removeChild(a)}async clearMatchResultsConfirmed(){this.matchHistory=[],await c.saveMatchHistory(this.matchHistory),this.calculateStandings(),this.requestUpdate()}openConfirmationModal(){this.confirmationModalOpen=!0}closeConfirmationModal(){this.confirmationModalOpen=!1}async clearStandingsConfirmed(){this.standings=[],this.matchHistory=[],await c.removeItem(h.MATCH_HISTORY),this.calculateStandings(),this.requestUpdate(),this.closeConfirmationModal()}setActiveTab(e){this.activeTab=e}render(){return this.isLoading?n`
    ...
    `}};p.styles=[O,w,A];d([o()],p.prototype,"activeTab",2);d([o()],p.prototype,"players",2);d([o()],p.prototype,"matchHistory",2);d([o()],p.prototype,"standings",2);d([o()],p.prototype,"isLoading",2);d([o()],p.prototype,"editModalOpen",2);d([o()],p.prototype,"editMatchIndex",2);d([o()],p.prototype,"confirmationModalOpen",2);p=d([g("standings-tracker")],p);
//# sourceMappingURL=standings-tracker-BMGZcuqv.js.map
