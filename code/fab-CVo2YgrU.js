import{a as u,s as x,c as H,n as d,r as o,e as $,i as g,A as m,b as p,t as b}from"./shoelace-styles-DuBzW-jG.js";import{t as w,l as f}from"./table-styles-DrheAqdc.js";import"./alert-styles-cAzKvmdU.js";import{c as L}from"./counter-styles-D82i61Ku.js";import{a as k}from"./app-home-CPzBWFH8.js";const P=u`
.ms {
  position: relative;
}
.ms-small::after {
...
`;var O=Object.defineProperty,T=Object.getOwnPropertyDescriptor,n=(e,a,l,i)=>{for(var t=i>1?void 0:i?T(a,l):a,s=e.length-1,c;s>=0;s--)(c=e[s])&&(t=(i?c(a,l,t):c(t))||t);return i&&t&&O(a,l,t),t};let r=class extends g{constructor(){super(),this.handle1={life:40},this.handle2={life:40},this.handle3={life:40},this.handle4={life:40},this.activeTab="standings",this.matchResults=[],this.playerHandle1="Player 1",this.playerHandle2="Player 2",this.playerHandle3="Player 3",this.playerHandle4="Player 4",this.initialLifeTracker=40,this.isAlertOpen=!1,this.storageKey="playerData",this.gameHistory=[],this.playerLogs=[],this.playerHandle1Actions=[],this.playerHandle2Actions=[],this.playerHandle3Actions=[],this.playerHandle4Actions=[],this.loadFromStorage()}firstUpdated(){this.saveToStorage()}setActiveTab(e){this.activeTab=e}updateLife(e,a,l){const t={1:{handle:this.handle1,playerHandle:this.playerHandle1,setter:s=>{this.handle1=s}},2:{handle:this.handle2,playerHandle:this.playerHandle2,setter:s=>{this.handle2=s}},3:{handle:this.handle3,playerHandle:this.playerHandle3,setter:s=>{this.handle3=s}},4:{handle:this.handle4,playerHandle:this.playerHandle4,setter:s=>{this.handle4=s}}}[e];if(t){const s=Math.max(0,t.handle.life+a);t.setter({...t.handle,life:s}),console.log(`${l} ${Math.abs(a)} to ${s} for ${t.playerHandle}`),this.playerLogs=[...this.playerLogs,{player:t.playerHandle,action:`${l}`,life:s}],this.saveToStorage()}}getPlayerIconVariant(e){return e.action.includes("Lose")?"loyalty-down":e.action.includes("Gain")?"loyalty-up":void 0}getPlayerBadgeVariant(e){return e.action.includes("Lose")?"danger":e.action.includes("Gain")?"success":void 0}setInitialLifeTracker(e){const a=e.target,l=parseInt(a.value,10);!isNaN(l)&&l>=0?(this.initialLifeTracker=l,this.handle1={life:l},this.handle2={life:l},this.handle3={life:l},this.handle4={life:l},this.saveToStorage()):(alert("Please enter a valid positive number for starting life."),a.value=this.initialLifeTracker.toString())}handlePlayerHandleChange(e,a){const i={1:{name:"Player 1",setter:t=>{this.playerHandle1=t}},2:{name:"Player 2",setter:t=>{this.playerHandle2=t}},3:{name:"Player 3",setter:t=>{this.playerHandle3=t}},4:{name:"Player 4",setter:t=>{this.playerHandle4=t}}}[e];if(i){const t=a.target.value||i.name;i.setter(t),this.saveToStorage()}}recordResult(e){let a="loss",l="loss",i="loss",t="loss";e===1?(a="win",l="loss",i="loss",t="loss"):e===2?(a="loss",l="win",i="loss",t="loss"):e===3?(a="loss",l="loss",i="win",t="loss"):e===4?(a="loss",l="loss",i="loss",t="win"):e==="draw"&&(a="draw",l="draw",i="draw",t="draw");const s={player1Handle:this.playerHandle1,player2Handle:this.playerHandle2,player3Handle:this.playerHandle3,player4Handle:this.playerHandle4,player1LifeTracker:this.handle1.life,player2LifeTracker:this.handle2.life,player3LifeTracker:this.handle3.life,player4LifeTracker:this.handle4.life,player1Outcome:a,player2Outcome:l,player3Outcome:i,player4Outcome:t};this.matchResults=[...this.matchResults,s],this.saveToStorage(),this.resetLife()}closeAlert(){this.isAlertOpen=!1}resetWithAlert(){this.resetGame(),this.isAlertOpen=!0}resetGame(){this.handle1={life:this.initialLifeTracker},this.handle2={life:this.initialLifeTracker},this.handle3={life:this.initialLifeTracker},this.handle4={life:this.initialLifeTracker},this.playerLogs=[],this.playerHandle1="Player 1",this.playerHandle2="Player 2",this.playerHandle3="Player 3",this.playerHandle4="Player 4",this.matchResults=[]}resetLife(){this.handle1={life:this.initialLifeTracker},this.handle2={life:this.initialLifeTracker},this.handle3={life:this.initialLifeTracker},this.handle4={life:this.initialLifeTracker},this.playerLogs=[]}saveToStorage(){const e={initialLifeTracker:this.initialLifeTracker,matchResults:this.matchResults,handle1:this.handle1,handle2:this.handle2,handle3:this.handle3,handle4:this.handle4,playerHandle1:this.playerHandle1,playerHandle2:this.playerHandle2,playerHandle3:this.playerHandle3,playerHandle4:this.playerHandle4,playerLogs:this.playerLogs};f.setItem(this.storageKey,e).catch(console.error)}loadFromStorage(){f.getItem(this.storageKey).then(e=>{e&&(this.initialLifeTracker=e.initialLifeTracker||20,this.matchResults=e.matchResults||[],this.handle1=e.handle1||{life:20},this.handle2=e.handle2||{life:20},this.handle3=e.handle3||{life:20},this.handle4=e.handle4||{life:20},this.playerHandle1=e.playerHandle1||"Player 1",this.playerHandle2=e.playerHandle2||"Player 2",this.playerHandle3=e.playerHandle3||"Player 3",this.playerHandle4=e.playerHandle4||"Player 4",this.playerHandle1Actions=e.playerHandle1Actions||[],this.playerHandle2Actions=e.playerHandle2Actions||[],this.playerHandle3Actions=e.playerHandle3Actions||[],this.playerHandle4Actions=e.playerHandle4Actions||[],this.playerLogs=e.playerLogs)}).catch(console.error)}getPlayerStats(e){const a=this.matchResults.filter(s=>s.player1Handle===e||s.player2Handle===e||s.player3Handle===e||s.player4Handle===e),l=a.filter(s=>s.player1Handle===e&&s.player1Outcome==="win"||s.player2Handle===e&&s.player2Outcome==="win"||s.player3Handle===e&&s.player3Outcome==="win"||s.player4Handle===e&&s.player4Outcome==="win").length,i=a.filter(s=>s.player1Handle===e&&s.player1Outcome==="loss"||s.player2Handle===e&&s.player2Outcome==="loss"||s.player3Handle===e&&s.player3Outcome==="loss"||s.player4Handle===e&&s.player4Outcome==="loss").length,t=a.filter(s=>s.player1Handle===e&&s.player1Outcome==="draw"||s.player2Handle===e&&s.player2Outcome==="draw"||s.player3Handle===e&&s.player3Outcome==="draw"||s.player4Handle===e&&s.player4Outcome==="draw").length;return{wins:l,losses:i,draws:t}}exportToCSV(){const e="data:text/csv;charset=utf-8,"+this.convertArrayOfObjectsToCSV(this.matchResults),a=encodeURI(e),l=document.createElement("a");l.setAttribute("href",a),l.setAttribute("download","game_results.csv"),document.body.appendChild(l),l.click(),document.body.removeChild(l)}convertArrayOfObjectsToCSV(e){if(!e||e.length===0)return"";const a=Object.keys(e[0]).join(","),l=e.map(i=>Object.values(i).map(t=>`"${t}"`).join(",")).join(`
`);return a+`
`+l}render(){const e=new Map;this.playerLogs.forEach(t=>{e.has(t.player)||e.set(t.player,[]);const s=this.getPlayerIconVariant(t),c=this.getPlayerBadgeVariant(t),v=p`
          <sl-menu-item>
            ${s?p`<sl-icon slot="prefix" library="mana" name=${String(s)}></sl-icon>`:m}
            ${t.action}
            ${c?p`<sl-badge variant=${String(c)} pill>1</sl-badge>`:m} life to <sl-badge variant="neutral">${t.life}</sl-badge>
          </sl-menu-item>
        `;e.get(t.player)?.push(v)});const a=[];for(const[t,s]of e)a.push(p`
    ...
    `];n([d({type:Object})],r.prototype,"handle1",2);n([d({type:Object})],r.prototype,"handle2",2);n([d({type:Object})],r.prototype,"handle3",2);n([d({type:Object})],r.prototype,"handle4",2);n([o()],r.prototype,"activeTab",2);n([o()],r.prototype,"matchResults",2);n([o()],r.prototype,"playerHandle1",2);n([o()],r.prototype,"playerHandle2",2);n([o()],r.prototype,"playerHandle3",2);n([o()],r.prototype,"playerHandle4",2);n([o()],r.prototype,"initialLifeTracker",2);n([o()],r.prototype,"isAlertOpen",2);n([$(".alert-closable")],r.prototype,"alert",2);n([d({type:Array})],r.prototype,"gameHistory",2);n([o()],r.prototype,"playerLogs",2);n([o()],r.prototype,"playerHandle1Actions",2);n([o()],r.prototype,"playerHandle2Actions",2);n([o()],r.prototype,"playerHandle3Actions",2);n([o()],r.prototype,"playerHandle4Actions",2);r=n([b("match-tracker")],r);var S=Object.defineProperty,A=Object.getOwnPropertyDescriptor,y=(e,a,l,i)=>{for(var t=i>1?void 0:i?A(a,l):a,s=e.length-1,c;s>=0;s--)(c=e[s])&&(t=(i?c(a,l,t):c(t))||t);return i&&t&&S(a,l,t),t};let h=class extends g{constructor(){super(...arguments),this.icon="arrow-left",this.isOpen=!1,this.message="",this.pointsTracker=""}openFab(e){this.pointsTracker=e,this.isOpen=!0}open(e){this.message=e,this.isOpen=!0}close(){this.dispatchEvent(new CustomEvent("close")),this.isOpen=!1}render(){return this.isOpen?p`
      <sl-drawer
        placement="top"
        label="Drawer"
        with-header
      ...
      >
        <sl-icon-button slot="header-actions" name="info-circle" href="${k("about")}"></sl-icon-button>
                <sl-input
          type="number"
    ...
    `:p``}};y([d({type:String})],h.prototype,"icon",2);y([d({type:Boolean})],h.prototype,"isOpen",2);y([d({type:String})],h.prototype,"message",2);y([d({type:String})],h.prototype,"pointsTracker",2);h=y([b("fab-drawer")],h);
//# sourceMappingURL=fab-CVo2YgrU.js.map
